...
\begin{frame}{Combinators I, K, and \( K_* \)}
  \begin{block}{Proposition:}
    Let \( I \), \( K \), and \( K_* \) be defined as:
    \begin{itemize}
      \item \( I = \lambda x.x \)
      \item \( K = \lambda xy.x \)
      \item \( K_* = \lambda xy.y \)
    \end{itemize}
    Then, for all \(\lambda\)-terms \(M\) and \(N\), we have:
    \begin{itemize}
      \item \( I M \rightarrow_{\beta} M \)
      \item \( K M N \rightarrow_{\beta} M \)
      \item \( K_* M N \rightarrow_{\beta} N \)
    \end{itemize}
  \end{block}
\end{frame}
