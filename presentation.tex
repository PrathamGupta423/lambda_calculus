...
\textbf{Hilbert's program:}
\begin{itemize}
    \item Formalize all of mathematics in a consistent axiomatic system. Such that:
    \begin{itemize}
      \item \textbf{Consistency:} No contradictions can be derived from the axioms.
      \item \textbf{Completeness:} All true statements can be derived from the axioms.
      \item \textbf{Decidability:} There exists a mechanical procedure to determine the truth of any statement.
    \end{itemize}
...
However, point (2) remained open—this became the \textbf{Entscheidungsproblem} ("decision problem"):\\
\begin{quote}
...
\begin{itemize}
    ...
    \item Class of functions computable by these is called \textbf{Recursive Functions}.
\end{itemize}
...
\begin{frame}{Church–Rosser Theorem}
  ...
  \end{theorem}
  \begin{block}{Note}
    For proof of equivivalence of two, please refer to the Appendix section.
  \end{block}
\end{frame}
